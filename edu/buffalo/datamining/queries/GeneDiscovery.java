...
public class GeneDiscovery {
	...
	public GeneDiscovery(String diseaseName,double aplha) {
		this.alpha=alpha*2;
	...
	public int evaluate() {
		...
		try{
			HashMap<Integer,ArrayList<Integer>>diseaseExpressions=operations.getDiseaseGroupValues(diseaseName);
			HashMap<Integer,ArrayList<Integer>>controlExpressions=operations.geControlGroupValues(diseaseName);
